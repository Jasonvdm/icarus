...
featureMat = numpy.loadtxt('Data/DefendersFeatureMatrix.csv',delimiter = ",")
labels = numpy.loadtxt('Data/DefendersSalary.csv',delimiter =",")
headers = numpy.loadtxt('Data/Headers.csv', dtype = str , delimiter=",")
...
#  	print headers[index] +": "+str(model.coef_[0][index])
